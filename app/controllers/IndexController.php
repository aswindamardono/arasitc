...
class IndexController extends BaseController
{
	...
	function index()
	{
		$page_title = $this->view->page_title = "Data Center";
	...
	function register($formdata = null)
	{
		if ($formdata) {
			...
			$db = $this->GetModel();
			$tablename = $this->tablename;
			$fields = $this->fields = array("username", "email", "password", "tgl_lahir", "no_hp", "instansi", "alamat", "materi", "photo"); //registration fields
