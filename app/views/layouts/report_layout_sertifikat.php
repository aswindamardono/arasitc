...
<body>
	...
	<?php 
	$data = $this->view_data;
	$sql= "SELECT* FROM sertifikat_depan WHERE id='".$data['id']."'";
	...
	<div id="page-show">
		<div class="image">
			...
			<p class="no_legal"><?php echo($ambildata['no_disnaker']); ?></p>
			<?php 
			$no_disnaker = $ambildata['no_disnaker'];
			...
			<img width="100%" height="100%" src="<?php print_link("assets/images/sertif_depan.jpg") ?>" >
	...
	<script type="text/javascript">
		...
		function makeCode () {	
			var elText = '<?php echo "$no_disnaker || $nama_sertifikat || $materi_sertifikat || Silahkan cek dengan login ke data.arasitc.com"; ?>';
