...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Absensi</h4>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-username_absensi"  value="<?php  echo $data['username_absensi']; ?>" type="text" placeholder="Enter Username Absensi"  required="" name="username_absensi"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
