                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    <label class="custom-control custom-checkbox custom-control-inline">
                                                        <input class="optioncheck custom-control-input" name="optioncheck[]" value="<?php echo $data['id_absen'] ?>" type="checkbox" />
                                                            <span class="custom-control-label"></span>
                                                        </label>
                                                    </th>
                                                    <?php } ?>
                                                    ...
                                                    <td class="td-username_absensi">
                                                        <span <?php if($can_edit){ ?> data-value="<?php echo $data['username_absensi']; ?>" 
                                                            data-pk="<?php echo $data['id_absen'] ?>" 
                                                            data-url="<?php print_link("absensi/editfield/" . urlencode($data['id_absen'])); ?>" 
                                                            data-name="username_absensi" 
                                                            data-title="Enter Username Absensi" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
                                                            data-mode="popover" 
                                            ...
                                            <div class="col-md-12 comp-grid">
                                                <form method="get" action="<?php print_link($current_page) ?>" class="form filter-form">
                                                    <div class="card mb-3">
                                                        ...
                                                        <div class="p-2">
                                                            <input class="form-control datepicker"  value="<?php echo $this->set_field_value('absensi_jam_msk') ?>" type="datetime"  name="absensi_jam_msk" placeholder="Klik disini untuk mencari tanggal" data-enable-time="" data-date-format="Y-m-d" data-alt-format="M j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                                            </div>
                                                        </div>
                                                        <hr />
