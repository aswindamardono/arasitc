...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Kuitansifix</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="kuitansifix-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("kuitansifix/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-id"  value="<?php echo $comp_model->kuitansifix_id_default_value() ?>" type="number" placeholder="Enter Id (Klik Disini Dulu !)" step="1"  required="" name="id"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-materi"  value="<?php  echo $this->set_field_value('materi',""); ?>" type="text" placeholder="Enter Materi"  required="" name="materi"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
