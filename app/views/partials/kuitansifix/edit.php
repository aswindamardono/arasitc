...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Kuitansifix</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("kuitansifix/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="id">Id (Klik Disini Dulu !) <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-id"  value="<?php  echo $data['id']; ?>" type="number" placeholder="Enter Id (Klik Disini Dulu !)" step="1"  required="" name="id"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <label class="control-label" for="no_kuitansi">No Kuitansi <span class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-sm-8">
                                                <div class="">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <select required=""  id="ctrl-id_user" data-load-select-options="nama" name="id_user"  placeholder="Select a value ..."    class="custom-select" >
                                                        <option value="">Select a value ...</option>
                                                        <?php
                                                        $rec = $data['id_user'];
                                                        $id_user_options = $comp_model -> kuitansifix_id_user_option_list();
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <select required=""  id="ctrl-nama" data-load-path="<?php print_link('api/json/kuitansifix_nama_option_list') ?>" name="nama"  placeholder="Select a value ..."    class="custom-select" >
                                                        <?php
                                                        $rec = $data['nama'];
                                                        $nama_options = $comp_model -> kuitansifix_nama_option_list($data['id_user']);
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-materi"  value="<?php  echo $data['materi']; ?>" type="text" placeholder="Enter Materi"  required="" name="materi"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
