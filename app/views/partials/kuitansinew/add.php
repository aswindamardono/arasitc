...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Kuitansinew</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="kuitansinew-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("kuitansinew/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                <?php
                                $kode_controller = new KuitansiController;
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-no_kuitansi"  value="<?php  echo $this->set_field_value('no_kuitansi',$kode); ?>" type="text" placeholder="Enter No Kuitansi"  required="" name="no_kuitansi"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
