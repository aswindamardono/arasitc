                                                ...
                                                <tr>
                                                    ...
                                                    <th class="td-btn">
                                                        <?php if ($can_view) { ?>
                                                            <a class="btn btn-sm btn-success has-tooltip"
                                                                href="<?php print_link("sertifikat/view/$rec_id"); ?>">
                                                                <i class="fa fa-eye"></i>
                                                            </a>
                                                        <?php } ?>
                                                        <?php if ($can_edit) { ?>
                                                            <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record"
                                                                href="<?php print_link("sertifikat/edit/$rec_id"); ?>">
                                                        ...
                                                        <?php if ($can_delete) { ?>
                                                            <a class="btn btn-sm btn-danger has-tooltip record-delete-btn"
                                                                ...
                                                                href="<?php print_link("sertifikat/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>"
                                                    ...
                                                    <td class="td-no_sertifikat">
                                                        <span <?php if ($can_edit) { ?>
                                                                data-value="<?php echo $data['no_sertifikat']; ?>"
                                                                data-pk="<?php echo $data['id'] ?>"
                                                                data-url="<?php print_link("sertifikat/editfield/" . urlencode($data['id'])); ?>"
                                                                data-name="no_sertifikat" data-title="Enter No Sertifikat"
                                                    ...
                                                    <td class="td-nama_sertifikat">
                                                        <span <?php if ($can_edit) { ?> data-source='<?php
                                                           ...
                                                           print_link('api/json/sertifikat_nama_sertifikat_option_list/' . $dependent_field);
                                            ...
                                            <div class="p-3 d-flex justify-content-between">
                                                <?php if ($can_delete) { ?>
                                                    <button data-prompt-msg="Are you sure you want to delete these records?"
                                                        data-display-style="modal"
                                                        data-url="<?php print_link("sertifikat/delete/{sel_ids}/?csrf_token=$csrf_token&redirect=$current_page"); ?>"
