                                                ...
                                                <tr>
                                                    ...
                                                    <th class="td-btn">
                                                        <?php if ($can_view) { ?>
                                                            <a class="btn btn-sm btn-success has-tooltip"
                                                                href="<?php print_link("sertifikat_depan/view/$rec_id"); ?>">
                                                                <i class="fa fa-eye"></i>
                                                            </a>
                                                        <?php } ?>
                                                        <?php if ($can_edit) { ?>
                                                            <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record"
                                                                href="<?php print_link("sertifikat_depan/edit/$rec_id"); ?>">
                                                        ...
                                                        <?php if ($can_delete) { ?>
                                                            <a class="btn btn-sm btn-danger has-tooltip record-delete-btn"
                                                                ...
                                                                href="<?php print_link("sertifikat_depan/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>"
                                                    ...
                                                    <td class="td-no_disnaker">
                                                        <span <?php if ($can_edit) { ?>
                                                                data-value="<?php echo $data['no_disnaker']; ?>"
                                                                data-pk="<?php echo $data['id'] ?>"
                                                                data-url="<?php print_link("sertifikat_depan/editfield/" . urlencode($data['id'])); ?>"
                                                                data-name="no_disnaker" data-title="Enter No Disnaker"
                                                    ...
                                                    <td class="td-tgl_sertifikat">
                                                        <span <?php if ($can_edit) { ?>
                                                                ...
                                                                data-pk="<?php echo $data['id'] ?>"
                                                                data-url="<?php print_link("sertifikat_depan/editfield/" . urlencode($data['id'])); ?>"
                                                                data-name="tgl_sertifikat" data-title="Enter Tgl Sertifikat"
                                                                data-placement="left" data-toggle="click" data-type="text"
                                                                data-mode="popover" data-showbuttons="left" class="is-editable"
                                                            <?php } ?>>
                                                    ...
                                                    <td class="td-materi_sertifikat">
                                                        <span <?php if ($can_edit) { ?>
                                                                data-value="<?php echo $data['materi_sertifikat']; ?>"
                                                                data-pk="<?php echo $data['id'] ?>"
                                                                data-url="<?php print_link("sertifikat_depan/editfield/" . urlencode($data['id'])); ?>"
                                                                data-name="materi_sertifikat" data-title="Enter Materi Sertifikat"
                                                                data-placement="left" data-toggle="click" data-type="text"
                                                                data-mode="popover" data-showbuttons="left" class="is-editable"
                                                            <?php } ?>>
                                            ...
                                            <div class="p-3 d-flex justify-content-between">
                                                <?php if ($can_delete) { ?>
                                                    <button data-prompt-msg="Are you sure you want to delete these records?"
                                                        data-display-style="modal"
                                                        data-url="<?php print_link("sertifikat_depan/delete/{sel_ids}/?csrf_token=$csrf_token&redirect=$current_page"); ?>"
