                                ...
                                <table class="table  table-striped table-sm text-left">
                                    <thead class="table-header bg-light">
                                        <tr>
                                            ...
                                            <th class="td-instansi"> Instansi</th>
                                    ...
                                    if (!empty($records)) {
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            foreach ($records as $data) {
                                                ...
                                                $counter++;
                                                ?>
                                                <tr <?php if ($data['user_role_id'] == "0" && $data['account_status'] == "Pending")
                                                    echo 'class="new-user"'; ?>>
                                                    <?php if ($can_delete) { ?>
                                                        <th class=" td-checkbox">
                                                            <label class="custom-control custom-checkbox custom-control-inline">
                                                    ...
                                                    <td class="td-username">
                                                        <span <?php if ($can_edit) { ?>
                                                                ...
                                                                data-name="username" data-title="Enter Nama Lengkap"
                                                    ...
                                                    <td class="td-email"><a
                                                            href="<?php print_link("mailto:$data[email]") ?>"><?php echo $data['email']; ?></a>
                                                    </td>
                                                    <td class="td-photo"><?php Html::page_img($data['photo'], 50, 50, 1); ?>
                                                    </td>
                                                    <td class="td-user_role_id">
                                                        <span <?php if ($can_edit) { ?>
                                                                data-source='<?php echo json_encode_quote(Menu::$user_role_id); ?>'
                                                                data-value="<?php echo $data['user_role_id']; ?>"
                                                                data-pk="<?php echo $data['id'] ?>"
                                                                data-url="<?php print_link("user/editfield/" . urlencode($data['id'])); ?>"
                                                                data-name="user_role_id" data-title="Select a value ..."
                                                    ...
                                                    <td class="td-account_status">
                                                        <span <?php if ($can_edit) { ?>
                                                                data-source='<?php echo json_encode_quote(Menu::$account_status); ?>'
                                                                data-value="<?php echo $data['account_status']; ?>"
                                                                data-pk="<?php echo $data['id'] ?>"
                                                                data-url="<?php print_link("user/editfield/" . urlencode($data['id'])); ?>"
                                                                data-name="account_status" data-title="Select a value ..."
                                                                data-placement="left" data-toggle="click" data-type="select"
                                                                data-mode="popover" data-showbuttons="left" class="is-editable"
                                                            <?php } ?>>
                                                    ...
                                                    <td class="td-tgl_lahir">
                                                        <span <?php if ($can_edit) { ?>
                                                                ...
                                                                data-pk="<?php echo $data['id'] ?>"
                                                                data-url="<?php print_link("user/editfield/" . urlencode($data['id'])); ?>"
                                                                data-name="tgl_lahir" data-title="Enter Tgl Lahir"
                                                    ...
                                                    <td class="td-no_hp">
                                                        <span <?php if ($can_edit) { ?>
                                                                ...
                                                                data-pk="<?php echo $data['id'] ?>"
                                                                data-url="<?php print_link("user/editfield/" . urlencode($data['id'])); ?>"
                                                                data-name="no_hp" data-title="Enter No Hp" data-placement="left"
                                                    ...
                                                    <td class="td-instansi">
                                                        <span <?php if ($can_edit) { ?>
                                                                ...
                                                                data-pk="<?php echo $data['id'] ?>"
                                                                data-url="<?php print_link("user/editfield/" . urlencode($data['id'])); ?>"
                                                                data-name="instansi" data-title="Enter Instansi"
                                                                data-placement="left" data-toggle="click" data-type="text"
                                                                data-mode="popover" data-showbuttons="left" class="is-editable"
                                                            <?php } ?>>
                                                    ...
                                                    <td class="td-alamat">
                                                        <span <?php if ($can_edit) { ?> data-pk="<?php echo $data['id'] ?>"
                                                                data-url="<?php print_link("user/editfield/" . urlencode($data['id'])); ?>"
                                                                data-name="alamat" data-title="Enter Alamat" data-placement="left"
                                                    ...
                                                    <th class="td-btn">
                                                        ...
                                                        <?php if ($can_delete) { ?>
                                                            <a class="btn btn-sm btn-danger has-tooltip record-delete-btn"
                                                                ...
                                                                href="<?php print_link("user/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>"
                                            ...
                                            <div class="p-3 d-flex justify-content-between">
                                                <?php if ($can_delete) { ?>
                                                    <button data-prompt-msg="Are you sure you want to delete these records?"
                                                        data-display-style="modal"
                                                        data-url="<?php print_link("user/delete/{sel_ids}/?csrf_token=$csrf_token&redirect=$current_page"); ?>"
